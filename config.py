...
commandsList = (
    "<b>🛠COMMANDS🎭</b> \n\n" 
    "• /help - <i>список команд та інформації по них</i> \n\n" 
    "• /new - <i>додати нову згадку про день народження</i> \n\n"
    "• /list - <i>вивести список днів народження</i> \n\n"
    "• <s>/delete - <i>видалити згадку</i></s> (currently unavaliable)\n\n"
)
